...
\section{Future Work}
\begin{itemize}[leftmargin=1.25em]
    \item Alternative color encodings (hp in volume, multi-field transfer functions).
    \item Better temporal alignment or interactive filtering per decade/song.
    \item Optimizations (compute ray marcher, adaptive grids).
\end{itemize}
